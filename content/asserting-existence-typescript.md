...
{
  "kind": "article",
  "title": "Asserting existence in Typescript (and JavaScript)",
  "description": "Often you'll know that a variable is defined, despite Typescript insisting otherwise. Use assertions to fix it, not optional chaining or non-null assertion operators!",
  "publishedAt": "2025-02-02T21:41:19.100Z",
  "tags": [
    "typescript",
    "javascript",
    "node",
...
_(You also have some even-worse workarounds, but let's skip right past those.)_
...
You might have good reasons to believe otherwise, and even _know_ otherwise for the code as it is right now. But how often can you guarantee otherwise _into the unknown future_? Can you guarantee that future refactors, features, or _bugs_ won't cause your claim of guaranteed-existence to fail?
...
- Your belief is now _functionally proven_ with _future guarantees_: you move from internal confidence that the thing will always exist to external validation that it does.
